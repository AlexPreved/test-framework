...
public final class TestDataGenerator {
    ...
    /**
     * @TODO этот генератор не учитывает тип данных или substr имени поля, а так же в листе заполняет только одно значение
     * @TODO все @gen-модели должны быть унаследованы от baseMode не понятно для чего
     * @TODO Рассмотрите возможность использования библиотек для автоматической генерации данных, таких как Instancio
     * или Java Faker. Эти библиотеки позволяют генерировать данные без явного использования рефлексии,
     * что может повысить производительность и упростить код.
     *
     */
